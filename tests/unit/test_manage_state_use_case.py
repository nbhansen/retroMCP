...
class TestManageStateUseCase:
    ...
    def test_load_state_not_found(
        ...
        mock_state_repository.load_state.side_effect = FileNotFoundError("State file not found")
    ...
    def test_update_state_field(
        ...
        mock_state_repository.update_state_field.assert_called_once_with("system.hardware", "Pi 5")
